...
/* Function prototypes
 * ********************************************************/
void mirror_dsp64(t_mirror* x, t_object* dsp64, short* count,
                  double samplerate, long maxvectorsize, long flags);
void mirror_perform64(t_mirror* x, t_object* dsp64, double** ins, long numins,
...
int C74_EXPORT main()
{
    ...
    mirror_class = class_new("mirror~", (method)mirror_new,
                             (method)mirror_free, sizeof(t_mirror), 0, 0);
